...
public class RedBlackTree {
	...
	public void subInsertNodeFix(RedBlackTreeNode node) {
		...
		// 对于父节点为黑色时，兄弟节点可能包含有黑色节点时，需要把刚插入的节点旋转到父节点的位置上
	...
	public void deleteNodeOnly(RedBlackTreeNode node) {
		...
		if(fixNode != null){
			System.out.println(fixNode.value +"\t" + fixNode.color);
		}else{
	...
	public RedBlackTreeNode subDeleteNodeOnlyNext(RedBlackTreeNode node) {
		...
		// 后一个节点一定没有左节点
		// 1.4.1当后一个节点的右节点为空，后一个节点应当移动到被删除的节点处
		if (next.right == null) {

			// 1.4.1.1当被删除的节点为根节点
			if (node.parent == null) {

				// 1.4.1.1.1后一个节点是被删除的节点的右节点
				...
				// 1.4.1.1.2后一个节点是被删除的节点的右节点的最左子节点
				} else {
			...
			// 1.4.1.2当被删除的节点不为根节点
				...
				// 1.4.1.2.2后一个节点是被删除的节点的右节点的最左子节点
				} else {
		...
		// 1.4.2当后一个节点的右节点不空，后一个节点应当移动到被删除的节点处，且后一个节点的右节点应该移动到前一个节点处
		} else {

			// 1.4.2.1当被删除的节点为根节点
			if (node.parent == null) {

				// 1.4.2.1.1后一个节点是被删除的节点的右节点
				if (next.parent.equals(root)) {
				...
				// 1.4.2.1.2后一个节点是被删除的节点的右节点的最左子节点
				} else {
			...
			// 1.4.2.2当被删除的节点不为根节点
				...
				// 1.4.2.2.2后一个节点是被删除的节点的右节点的最左子节点
				} else {
