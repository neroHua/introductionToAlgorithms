 ...
 * 
 * 并行计算的中间工具
 * schedule：任务调度器，将执行的并行计算的代码分配到多核心运算器
 * 
 * 好在有两个例子：斐波那契数列，和归并排序
 * 不过很遗憾java中并没有向书中的那种关键字，我只能另寻他法了
 * 
 * @author 滑德友
 * 2018年6月20日08:23:05
 * 
...
public class MultiThreaded {
	...
	public static void main(String[] args) {
		...
		for (int i = 10 ; i > 3 ; i--) {
			FibonacciThread ft = new FibonacciThread(i);
			ft.start();
		}
		...
		// 通过调试查看变量值，发现fn已经是预期的情况了，然而输出确实有点辣眼睛
		for (int i = 0 ; i < 10 ; i++) {
			System.out.println(i+"\t---------"+FibonacciThread.fn[0]);
		}
