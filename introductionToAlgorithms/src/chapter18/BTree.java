...
public class BTree {
			...
			// 不能在前后子节点借情况
				...
				// 此时需要向父节点借
					...
					if(relationship == removeNode.parentNode.valueCount) {
						...
						while(!parentNext.equals(childPrevious)){
	...
	public static void main(String[] args) {
		...
		/*bTree.removeValue(bTree.root, 39);
		bTree.removeValue(bTree.root, 38);*/
		/*bTree.removeValue(bTree.root, 39);
		bTree.removeValue(bTree.root, 37);*/
		// bTree.removeValue(bTree.root, 36);
		/*bTree.insertValue(bTree.root, -1);
